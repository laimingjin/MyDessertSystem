...
public class Sale_ListAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		for(int i = 0;i<pl.size();i++){
			...
			Date newdate=simpleDateFormat.parse(da);
			if(pl.get(i).getStatus()!=1  || pl.get(i).getStarttime().compareTo(newdate)!=0){
				pl.remove(i);
				i--;
			}
		}

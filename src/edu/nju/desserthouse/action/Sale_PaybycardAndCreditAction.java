...
public class Sale_PaybycardAndCreditAction extends BaseAction{
	@Autowired
	...
	public String execute() throws Exception {
	    ...
	    double credit=(double)sc.getAttribute("credit");
		...
		boolean res=allsaleService.addAllsale(allsale);
		...
		member.setCredit((int)(totalPrice));
